...
public class NotaFiscalControllerTest extends AndroidTestCase {
	...
	public void testNotaFiscalAPartirDoValorBruto() {
		...
		NotaFiscalController notaFiscalController = new NotaFiscalController(valorBruto);
	...
	public void testNotaFiscalAPartirDoValorPorHoraEQtdeDeHoras() {
		...
		NotaFiscalController notaFiscalController = new NotaFiscalController(valorPorHora, qtdeHoras);
